...
function News() {
    ...
    useEffect(() => {
        setIsLoading(true);
        setError(null);
        fetch(`https://newspulseback.onrender.com/all-news?page=${page}&pageSize=${pageSize}`)
            .then(response => {
                if (response.ok) {
    ...
    return (
        <>
            ...
            <div className='md:mt-10 my-15 cards grid lg:place-content-center md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 xs:grid-cols-1 xs:gap-4 md:gap-10 lg:gap-14 md:px-16 xs:p-3 '>
